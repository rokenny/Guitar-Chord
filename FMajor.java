 ...
 * This class contains the F Major image and swaps images when selected or de-selected
 */
public class FMajor extends ShowChord
{
    ...
    {  
        ...
        {
            GreenfootImage img = new GreenfootImage("FMajor.png");
            setImage(img);
        }
        else if(ImageReader == true)
        {
            GreenfootImage img = new GreenfootImage("FSelected.png");
            setImage(img);
        }
        /** 
