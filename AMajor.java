 ...
 * This class contains the A Major image and swaps images when selected or de-selected
 */
public class AMajor extends ShowChord
{
    ...
    {  
        ...
        {
            GreenfootImage img = new GreenfootImage("AMajor.png");
            setImage(img);
        }
        else if(ImageReader == true)
        {
            GreenfootImage img = new GreenfootImage("ASelected.png");
            setImage(img);
        }
        /** 
