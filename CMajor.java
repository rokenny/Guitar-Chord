 ...
 * This class contains the C Major image and swaps images when selected or de-selected
 */
public class CMajor extends ShowChord
{
    ...
    {  
        ...
        {
            GreenfootImage img = new GreenfootImage("CMajor.png");
            setImage(img);
        }
        else if(ImageReader == true)
        {
            GreenfootImage img = new GreenfootImage("CSelected.png");
            setImage(img);
        }
        /** 
