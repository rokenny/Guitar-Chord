 ...
 * This class extends ShowChord and checks for the true or false reading of minor to determine the output
 *      and let the final value get accessed by ShowChord
 */
public class minor extends ShowChord
{
    /**
     * ImageReader is read by its boolean value by ShowChord
     * returns the selected or not selected image to the GUI
     * returns the boolean value of minor to ShowChord for analysis in the if statements
     */
    ...
    {  
        ...
        {
            GreenfootImage img = new GreenfootImage("Minor.png");
            setImage(img);
        }
        else if(ImageReader == true)
        {
            GreenfootImage img = new GreenfootImage("MinorSelected.png");
            setImage(img);
        }
        /** 
