 ...
 * This class contains the E Major image and swaps images when selected or de-selected
 */
public class EMajor extends ShowChord
{
    ...
    {  
        ...
        {
            GreenfootImage img = new GreenfootImage("EMajor.png");
            setImage(img);
        }
        else if(ImageReader == true)
        {
            GreenfootImage img = new GreenfootImage("ESelected.png");
            setImage(img);
        }
        /** 
