 ...
 * This class contains the B Major image and swaps images when selected or de-selected
 */
public class BMajor extends ShowChord
{
    ...
    {  
        ...
        {
            GreenfootImage img = new GreenfootImage("BMajor.png");
            setImage(img);
        }
        else if(ImageReader == true)
        {
            GreenfootImage img = new GreenfootImage("BSelected.png");
            setImage(img);
        }
        /** 
