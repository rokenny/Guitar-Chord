 ...
 * This class contains the D Major image and swaps images when selected or de-selected
 */
public class DMajor extends ShowChord
{
    ...
    {  
        ...
        {
            GreenfootImage img = new GreenfootImage("DMajor.png");
            setImage(img);
        }
        else if(ImageReader == true)
        {
            GreenfootImage img = new GreenfootImage("DSelected.png");
            setImage(img);
        }
        /** 
